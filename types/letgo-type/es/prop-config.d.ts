...
export type IPublicTypeBasicProp = 'array' | 'bool' | 'func' | 'number' | 'object' | 'string' | 'node' | 'element' | 'date' | 'any';
export type IPublicTypeComplexProp = IPublicTypeOneOf | IPublicTypeOneOfType | IPublicTypeArrayOf | IPublicTypeObjectOf | IPublicTypeShapeProp | IPublicTypeExactProp;
