import { IPublicTypeComponentMetadata } from './metadata';
import { EitherOr, IPublicTypeUtils } from './utils';
import { IPublicTypeReference } from './reference';
import { IPublicTypeComponentSchema, IPublicTypeProjectSchema } from '.';
export declare enum IPublicEnumAssetLevel {
    Environment = 1,
    Library = 2,
    Theme = 3,
    Runtime = 4,
...
export declare const AssetLevels: IPublicEnumAssetLevel[];
export declare enum IPublicEnumAssetType {
    JSUrl = "jsUrl",
    CSSUrl = "cssUrl",
    CSSText = "cssText",
    JSText = "jsText",
