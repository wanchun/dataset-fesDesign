import { IPublicModelDocumentModel, IPublicModelDropLocation, IPublicModelNode, IPublicTypeLocateEvent } from '..';
export interface IPublicTypeSensor<DocumentModel = IPublicModelDocumentModel, Node = IPublicModelNode> {
    /**
