import { ICodeStruct, IPublicTypeAppConfig, IPublicTypeComponentsMap, IPublicTypeI18nMap, IPublicTypeJSONObject, IPublicTypePackage, IPublicTypeRootSchema, IPublicTypeUtils } from '../..';
/**
 * 应用描述
 */
