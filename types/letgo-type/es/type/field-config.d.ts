import { IPublicModelSettingField, IPublicTypeFieldExtraProps, IPublicTypeSetterType } from '..';
/**
 * 属性面板配置
 */
export interface IPublicTypeFieldConfig<SettingField = IPublicModelSettingField> extends IPublicTypeFieldExtraProps<SettingField> {
    /**
