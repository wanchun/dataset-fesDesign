import { IPublicModelScrollTarget, IPublicTypeAutoFit, IPublicTypePoint, IPublicTypeScrollable } from '..';
export interface IPublicTypeViewport<ScrollTarget = IPublicModelScrollTarget> extends IPublicTypeScrollable<ScrollTarget> {
    /**
     * 视口大小
     */
    width: number;
