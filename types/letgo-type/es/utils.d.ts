...
import { IPublicTypeJSFunction } from './value-type';
...
type FilterOptional<T> = Pick<T, Exclude<{
    [K in keyof T]: T extends Record<K, T[K]> ? K : never;
}[keyof T], undefined>>;
type FilterNotOptional<T> = Pick<T, Exclude<{
...
export type EitherOr<O extends Record<string, any>, L extends string, R extends string> = (PartialEither<Pick<O, L | R>, L> | PartialEither<Pick<O, L | R>, R>) & Omit<O, L | R>;
export {};
