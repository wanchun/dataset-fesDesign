import { IPublicTypeNodeData, IPublicTypeSlotSchema } from '.';
/**
 * 变量表达式
 */
 ...
 * JSON 基本类型
 */
export type IPublicTypeJSONValue = boolean | string | number | null | undefined | IPublicTypeJSONArray | IPublicTypeJSONObject;
 ...
 * 复合类型
 */
export type IPublicTypeCompositeValue = IPublicTypeJSONValue | IPublicTypeJSExpression | IPublicTypeJSFunction | IPublicTypeJSSlot | IPublicTypeCompositeArray | IPublicTypeCompositeObject;
