import { IPublicTypeComponentAction, IPublicTypeComponentSchema, IPublicTypeFieldConfig, IPublicTypeNodeData, IPublicTypeNodeSchema, IPublicTypeNpmInfo, IPublicTypeProjectSchema, IPublicTypeTransformedComponentMetadata } from '..';
...
export interface IPublicModelComponentMeta<Node = IPublicModelNode> {
     ...
     * @param parent 父节点
     */
    checkNestingDown: (my: Node, target: IPublicTypeNodeSchema | Node | IPublicTypeNodeSchema[]) => boolean;
