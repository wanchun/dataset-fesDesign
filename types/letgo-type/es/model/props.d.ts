import { IPublicEnumTransformStage, IPublicExtrasObject, IPublicModelNode, IPublicModelProp, IPublicTypeCompositeValue, IPublicTypePropsList, IPublicTypePropsMap } from '..';
export interface IBaseModelProps<Node = IPublicModelNode, Prop = IPublicModelProp> {
    /**
     * 所属 Node 节点
     */
    readonly owner: Node;
