import { GlobalEvent, IPublicEnumTransformStage, IPublicModelComponentMeta, IPublicModelDocumentModel, IPublicModelNodeChildren, IPublicModelProp, IPublicModelProps, IPublicModelSettingTop, IPublicTypeCompositeValue, IPublicTypeNodeSchema, IPublicTypePropsList, IPublicTypePropsMap } from '../';
type IPropChangeOptions = Omit<GlobalEvent.Node.Prop.ChangeOptions, 'node'>;
export interface IBaseModelNode<DocumentModel = IPublicModelDocumentModel, Schema = IPublicTypeNodeSchema, Node = IPublicModelNode, NodeChildren = IPublicModelNodeChildren, ComponentMeta = IPublicModelComponentMeta, SettingTopEntry = IPublicModelSettingTop, Props = IPublicModelProps, Prop = IPublicModelProp> {
    /**
     * 节点 id
     * node id
     */
