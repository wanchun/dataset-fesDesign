import { IPublicModelDocumentModel, IPublicModelNode, IPublicTypeDisposable } from '..';
export interface IPublicModelDetecting<DocumentModel = IPublicModelDocumentModel, Node = IPublicModelNode> {
    /**
     * 是否启用
...
//# sourceMappingURL=detecting.d.ts.map