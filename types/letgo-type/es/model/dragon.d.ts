import { IPublicModelDocumentModel, IPublicModelDropLocation, IPublicModelNode, IPublicTypeDragObject, IPublicTypeLocateEvent, IPublicTypeLocationData, IPublicTypeSensor } from '..';
export interface IPublicModelDragon<DocumentModel = IPublicModelDocumentModel, Node = IPublicModelNode> {
