import { IPublicEditor, IPublicModelComponentMeta, IPublicModelDetecting, IPublicModelDocumentModel, IPublicModelDragon, IPublicModelGlobalSearch, IPublicModelNode, IPublicModelOffsetObserver, IPublicModelProject, IPublicModelSelection, IPublicModelSettingTop, IPublicModelSimulator, IPublicModelTips, IPublicTypeComponentMetadata, IPublicTypeComponentSchema, IPublicTypeDesignerProps, IPublicTypeNodeSelector, IPublicTypeNpmInfo, IPublicTypeProjectSchema, IPublicTypeSimulatorProps } from '..';
export interface IPublicModelDesigner<Project = IPublicModelProject, DocumentModel = IPublicModelDocumentModel, ComponentMeta = IPublicModelComponentMeta, Selection = IPublicModelSelection, Simulator = IPublicModelSimulator, Node = IPublicModelNode, Dragon = IPublicModelDragon, Detecting = IPublicModelDetecting, SettingTop = IPublicModelSettingTop> {
    readonly editor: IPublicEditor;
    readonly project: Project;
    readonly dragon: Dragon;
    readonly detecting: Detecting;
    readonly tips: IPublicModelTips;
    readonly globalSearch: IPublicModelGlobalSearch;
    get componentMetaMap(): Map<string, ComponentMeta>;
    get componentsMap(): {
        [key: string]: IPublicTypeNpmInfo | IPublicTypeProjectSchema<IPublicTypeComponentSchema>;
    };
