import { IPublicEnumTransformStage, IPublicModelCode, IPublicModelDocumentModel, IPublicModelSimulator, IPublicTypeProjectSchema, IPublicTypeRootSchema, IPublicTypeUtils } from '..';
export interface IBaseProject<DocumentModel, Code = IPublicModelCode, Simulator = IPublicModelSimulator> {
    id: string | number;
    css: string;
