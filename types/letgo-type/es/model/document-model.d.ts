import { IPublicEnumTransformStage, IPublicModelCode, IPublicModelComponentMeta, IPublicModelNode, IPublicModelProject, IPublicModelSelection, IPublicModelState, IPublicTypeDragNodeDataObject, IPublicTypeDragNodeObject, IPublicTypeNodeData, IPublicTypeNodeSchema, IPublicTypeRootSchema } from '../';
export interface IPublicModelDocumentModel<Project = IPublicModelProject, ComponentMeta = IPublicModelComponentMeta, Selection = IPublicModelSelection, Node = IPublicModelNode, State = IPublicModelState, Code = IPublicModelCode> {
    /**
     * id
     */
    id: string;
     ...
     * insert a node
     */
    insertNode: (parent: Node, thing: Node | IPublicTypeNodeData, at?: number | null | undefined, copy?: boolean | undefined) => Node | null;
    /**
     * 创建一个节点
     * create a node
     * @param data
     ...
     */
    checkNesting: (dropTarget: Node, dragObject: IPublicTypeDragNodeObject<Node> | IPublicTypeDragNodeDataObject) => boolean;
    checkDropTarget: (dropTarget: Node, dragObject: IPublicTypeDragNodeObject<Node> | IPublicTypeDragNodeDataObject) => boolean;
    /**
